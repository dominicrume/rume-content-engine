...
import { GeneratedContent, ContentTheme } from '../types';
import { User, Globe, MoreHorizontal, ThumbsUp, MessageSquare, Share2, Send } from 'lucide-react';
...
export const PostPreview: React.FC<PostPreviewProps> = ({ content, isLoading }) => {
  ...
  return (
    <div className="bg-white text-black rounded-lg overflow-hidden shadow-2xl max-w-xl mx-auto border border-gray-200 relative min-h-[400px]">
      {isLoading && (
          ...
          <div className="flex gap-3">
            ...
            <div>
              <div className="flex items-center gap-1">
                <h3 className="font-bold text-sm leading-tight">Rume Dominic</h3>
      ...
      <div className="px-4 py-3">
        {content && (
          <>
            <div className="mb-3">
              <ThemeBadge theme={content.theme} />
            </div>
